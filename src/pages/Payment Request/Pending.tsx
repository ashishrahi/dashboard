...
export default function FullFeaturedCrudGrid() {
  ...
  const columns: GridColDef[] = [
    ...
    {field: 'pickupdate',  headerName: 'Pickup date', type: 'date',width: 150,},
    { field: 'userdetails', headerName: 'User Details', width: 150 },
    { field: 'driverdetails', headerName: 'Driver Details', width: 150 },
    { field: 'paymentstatus', headerName: 'Payment Status', width: 150 },  // Fixed duplicate field name
    { field: 'totalproducts', headerName: 'Total Products', width: 150 },
