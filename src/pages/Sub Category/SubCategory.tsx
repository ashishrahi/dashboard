...
import AddCategoryModal from './addSubCategory'; // Adjust import if necessary
import UpdateCategoryModal from './updateSubCategory'; // Adjust import if necessary
import { useSubCategory, useStatusMutationSubCategory } from '../../services/Api/subcategoryApi/mutationSubcategory'; // Adjust import if necessary
...
const DataTable = () => {
  ...
  const columns = useMemo(() => [
    ...
    
    {
      ...
      width: 180,
      renderCell: (params) => (
        <Avatar src={params.row.image} alt={params.row.subcategoryname} />
      ),
    },
