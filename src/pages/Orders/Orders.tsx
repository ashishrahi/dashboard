...
const DataTable = () => {
  ...
  const columns = useMemo(() => [
    ...
    { field: 'pickupdate', headerName: 'Pickup Date', width: 180 },
    { field: 'user', headerName: 'Users Details', width: 180 },
    { field: 'driver', headerName: 'Driver Details', width: 180 },
    { field: 'warehouse', headerName: 'Warehouse Details', width: 200 },
    { field: 'totalproducts', headerName: 'Total Products', width: 250 },
    {
      field: 'status',
      headerName: 'Status',
      width: 120,
