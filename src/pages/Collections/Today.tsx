...
export default function FullFeaturedCrudGrid() {
  ...
  const columns: GridColDef[] = [
    {field: 'joinDate',  headerName: 'Pickup date', type: 'date',width: 150,},
    { field: 'categoryname', headerName: 'Category Name', width: 150 },
    { field: 'subcategoryname', headerName: 'Subcategory Name', width: 150 },
    { field: 'unitprice', headerName: 'Unit / Price', width: 150 },  // Fixed duplicate field name
